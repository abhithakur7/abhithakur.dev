...
timeframe: 2022 – 2023
order: 3
summary: Solo-built rebate platform — PostgreSQL data layer, AI-generated reports, S3 document handling, and an admin-reviewed submission workflow.
---
...
The product is no longer live. I was the only engineer on it — built the data layer, the ETL, the APIs, the AI workflows, the document handling, the admin tooling, and the front-end that fronted them.
